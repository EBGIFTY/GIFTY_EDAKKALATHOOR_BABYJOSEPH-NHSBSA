...
Feature: NHS Job Search Functionality
  ...
  Scenario Outline: TC-05:Jobseeker searches for a job and sorts by newest date posted with all filtered values via firefox browser
    Given I am a jobseeker on NHS Jobs website
    When I put all values into the Search functionality
      | jobTitle   | location   | jobReference   | employer   | distance   | payRange   |
      | <jobTitle> | <location> | <jobReference> | <employer> | <distance> | <payRange> |
  ...
  Scenario Outline: TC-06:Jobseeker searches for  invalid values in all filtered values via firefox browser
    Given I am a jobseeker on NHS Jobs website
    When I put all values into the Search functionality
      | jobTitle   | location   | jobReference   | employer   | distance   | payRange   |
      | <jobTitle> | <location> | <jobReference> | <employer> | <distance> | <payRange> |
