...
public class NhsJobSearchStepDef {
	...
	public void sort_my_search_results_with_the_newest_date_posted_if_the_job_results_avialable(String OptionText,
			String DropdownId) {
	...
	public void I_put_all_values_into_the_Search_functionalitys(DataTable dataTable) {
		...
		Hooks.test.log(LogStatus.INFO,
				"User adding filters : Entering job title: '" + jobTitle + "' and location: '" + location + "'");
